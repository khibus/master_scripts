...
export PATH=/progs2/openmpi-4.1.6/bin:$PATH
export LD_LIBRARY_PATH=/progs2/openmpi-4.1.6/lib:$LD_LIBRARY_PATH

# Here giving the path to the ORCA binaries and giving communication protocol

export orcadir=/progs2/orca6
...
if [ -f $SGE_O_WORKDIR/$1.out ]; then
 rm $SGE_O_WORKDIR/$1.out
fi
